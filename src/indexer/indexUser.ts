      ...
      if (oldUserIns !== null) {
        await db.userContract.update({
          ...
          data: {
            ...
            tonAmountNum: data.userBalances.TON.toString(),
            tsTonAmountNum: data.userBalances.tsTON.toString(),
            stTonAmountNum: data.userBalances.stTON.toString(),
            USDTAmountNum: data.userBalances.USDT.toString(),
            jUSDTAmountNum: data.userBalances.jUSDT.toString(),
            jUSDCAmountNum: data.userBalances.jUSDC.toString(),
            lastUtime: new Date(),
